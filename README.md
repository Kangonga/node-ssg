...
<!-- ABOUT THE PROJECT -->
## About The Project
This project is a simple custom static site generator, implemented in node JS. <br>

The code takes in markdown files from the 'src/content' folder, parses the data in each file, and generates a html file in an output folder 'dist'.

You can manually add an 'index.css' file in the css file to style the generated html files.
